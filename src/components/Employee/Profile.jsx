...
const Profile = () => {
  ...
  return (
    <div className='lg:px-16 md:px-10 mb-auto mt-10 w-full space-y-6 overflow-y-scroll h-full'>
      <h1 className='text-3xl font-[500]'>Employee Profile</h1>
      <div className='space-x-1.5 font-[500] text-gray-500'>
        <span>Job Board</span>
        <span>/</span>
        <span>DashBoard</span>
        <span>/</span>
        <span className='text-indigo-400 cursor-pointer'>Employee Profile</span>
      </div>
      <div className='border border-gray-200 rounded-xl pb-5 w-full'>
        ...
        <Box component='form' py={5} px={2}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <TextField label='Upload Resume' fullWidth />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField label='Phone' fullWidth />
            </Grid>
            <Grid item xs={12} md={6}>
              <Choices items={industry} type='Industry' />
            </Grid>
            <Grid item xs={12} md={6}>
      ...
      <div className='border border-gray-200 rounded-lg p-8'>
        <p className='mb-6 text-xl font-[500] text-gray-900'>Description</p>
        <SimpleMDE />
          ...
          <div className='flex items-center space-x-5 justify-center'>
            <div className='flex flex-col space-y-2 p-4'>
              ...
              <input
                ...
                className='text-gray-700 outline-none border border-gray-300 rounded-lg py-2.5 px-2 w-80'
              />
            </div>
            <div className='flex flex-col space-y-2 p-4'>
              <label
